<?php
// This MUST be the very first thing in your PHP file, before any HTML or output.
...
<body>
    <div class="login-container">
        ...
        if (isset($_SESSION['login_error'])) {
            echo '<div class="alert alert-danger mb-4">' . htmlspecialchars($_SESSION['login_error']) . '</div>';
